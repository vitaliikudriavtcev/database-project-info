...
BEGIN
  ...
  EXEC DDL.CreateTargetTable 'Target', '10_Fact_FakeDim1'
  EXEC [DML].[InsertIntoSourceTable] 'Target', '10_Fact_FakeDim1', 150000

  EXEC DDL.CreateTargetTable 'Target', '10_Fact_FakeDim2'
  EXEC [DML].[InsertIntoSourceTable] 'Target', '10_Fact_FakeDim2', 150000

  EXEC DDL.CreateTargetTable 'Target', '10_Fact_FakeDim3'
  EXEC [DML].[InsertIntoSourceTable] 'Target', '10_Fact_FakeDim3', 150000
