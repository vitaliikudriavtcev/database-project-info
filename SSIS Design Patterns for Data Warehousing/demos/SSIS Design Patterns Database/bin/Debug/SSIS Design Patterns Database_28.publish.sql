...
BEGIN
  ...
  EXEC [DDL].[CreateCUDProcs] 'CUD', '02_SCD_Type_1',            'Source', '02_SCD_Type_1', @InsertRowsSmallT1, @UpdateFromT1, @UpdateThruT1

  EXEC [DDL].[CreateCUDProcs] 'CUD', '03_SCD_Type_2_T1',            'Source', '03_SCD_Type_2', @InsertRowsSmallT1, @UpdateFromT1, @UpdateThruT1
  EXEC [DDL].[CreateCUDProcs] 'CUD', '03_SCD_Type_2_T2',            'Source', '03_SCD_Type_2', @InsertRowsSmallT2, @UpdateFromT2, @UpdateThruT2, @IncludeType2

  EXEC [DDL].[CreateCUDProcs] 'CUD', '04_Set_Based_Type_1' ,     'Source', '04_Set_Based_Type_1' , @InsertRows, @UpdateFromT1, @UpdateThruT1

  EXEC [DDL].[CreateCUDProcs] 'CUD', '04_Set_Based_Type_2_T1' ,     'Source', '04_Set_Based_Type_2' , @InsertRows, @UpdateFromT1, @UpdateThruT1
  EXEC [DDL].[CreateCUDProcs] 'CUD', '04_Set_Based_Type_2_T2' ,     'Source', '04_Set_Based_Type_2' , @InsertRows, @UpdateFromT2, @UpdateThruT2, @IncludeType2
