/*
Deployment script for SSIS Design Patterns Database
...
GO
:setvar DatabaseName "SSIS Design Patterns Database"
:setvar DefaultFilePrefix "SSIS Design Patterns Database"
...
BEGIN
  ...
  SET @sqlStatement = @sqlStatement + '  EXEC DML.UpdateSourceTable  ''' + @TableSchemaName + ''', ''' + @TableName + ''', ' + CAST(@UpdateFrom AS NVARCHAR) + ', ' + CAST(@UpdateThru AS NVARCHAR) + ' ' + @crlf
  SET @sqlStatement = @sqlStatement + ' ' + @crlf
...
BEGIN
  ...
  EXEC [DDL].[CreateCUDProcs] 'CUD', '02_SCD_Type_1',     'Source', '02_SCD_Type_1', @InsertRows, @UpdateFrom, @UpdateThru
  EXEC [DDL].[CreateCUDProcs] 'CUD', '03_SCD_Type_2',     'Source', '03_SCD_Type_2', @InsertRows, @UpdateFrom, @UpdateThru
...
BEGIN
  ...
  EXEC [DDL].[DropProcIfExists] 'CUD', '03_SCD_Type_2'
