...
GO
PRINT N'Altering [DDL].[CreateETLTable]...';


GO

ALTER PROCEDURE [DDL].[CreateETLTable]
...
BEGIN
  ...
  EXEC [DDL].[CreateCUDProcs] 'CUD', '03_SCD_Type_2',            'Source', '03_SCD_Type_2', @InsertRowsSmall, @UpdateFromT2, @UpdateThruT2, @IncludeType2
  EXEC [DDL].[CreateCUDProcs] 'CUD', '04_Set_Based_Type_1' ,     'Source', '04_Set_Based_Type_1' , @InsertRows, @UpdateFromT1, @UpdateThruT1
  EXEC [DDL].[CreateCUDProcs] 'CUD', '04_Set_Based_Type_2' ,     'Source', '04_Set_Based_Type_2' , @InsertRows, @UpdateFromT2, @UpdateThruT2, @IncludeType2
