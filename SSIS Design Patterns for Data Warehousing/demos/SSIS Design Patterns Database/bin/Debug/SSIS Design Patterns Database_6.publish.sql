...
BEGIN
  ...
  DECLARE @IncludeType2Change BIT = 1
  ...
  EXEC [DDL].[CreateCUDProcs] 'CUD', '03_SCD_Type_2',     'Source', '03_SCD_Type_2', @InsertRowsSmall, @UpdateFromSmall, @UpdateThruSmall, @IncludeType2Change
